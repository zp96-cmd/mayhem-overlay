...
contextBridge.exposeInMainWorld('mayhem', {
  ...
  getChampionCombos: () => ipcRenderer.invoke('data:champion-combos'),
  showCombos: (data) => ipcRenderer.send('combos:show', data),
  clearCombos: () => ipcRenderer.send('combos:clear'),
  onCombos: (cb) => ipcRenderer.on('combos:data', (_e, d) => cb(d)),
  onCombosClear: (cb) => ipcRenderer.on('combos:clear', () => cb()),
  combosResize: (w, h) => ipcRenderer.send('combos:resize', { w, h }),
  ...
  openPodium: () => ipcRenderer.send('podium:open'),
  closePodium: () => ipcRenderer.send('podium:close'),
  minimizePodium: () => ipcRenderer.send('podium:minimize'),
  ...
  onMultikill: (cb) => ipcRenderer.on('multikill:go', (_e, d) => cb(d)),
  ...
  clearPrio: () => ipcRenderer.send('prio:clear'),
  onPrio: (cb) => ipcRenderer.on('prio:data', (_e, d) => cb(d)),
  onPrioClear: (cb) => ipcRenderer.on('prio:clear', () => cb()),
  prioResize: (w, h) => ipcRenderer.send('prio:resize', { w, h }),
  prioDragBy: (dx, dy) => ipcRenderer.send('prio:dragby', { dx, dy }),
  prioDragEnd: () => ipcRenderer.send('prio:dragend'),
  prioLock: (v) => ipcRenderer.send('prio:lock', v),
  onPrioLock: (cb) => ipcRenderer.on('prio:lock-state', (_e, v) => cb(v)),
